...
var (
	appVersion = "v1.2.0"
	chainIDMap = map[string]int{"devnet": 662532, "testnet": 662531, "mainnet": 66253}
	...
	netnameFlag  = flag.String("faucet.name", "", "Network name to display on the frontend")
	symbolFlag   = flag.String("faucet.symbol", "NOBLE", "Token symbol to display on the frontend")
